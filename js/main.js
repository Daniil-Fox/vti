...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (contentEl && imgEl) {
    ...
    const submitForm = async () => {
      ...
      try {
        const result = await window.sendToTelegram(formData);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   sendFormWithFormspree: () => (/* binding */ sendFormWithFormspree),
...
async function sendToTelegram(formData) {
  try {
    ...
    const url = `https://api.telegram.org/bot${TELEGRAM_BOT_TOKEN}/sendMessage?chat_id=${TELEGRAM_CHAT_ID}&parse_mode=html&text=${encodedMessage}`;
...
// Альтернатива: если нужны файлы, используйте Formspree
